...
class StringPracticeTest extends StringPractice {
  ...
  void testNumPunctAfterNonPunct() {
    assertEquals(0, StringPractice.numPunctAfterNonPunct("thisshne"));
    assertEquals(0, StringPractice.numPunctAfterNonPunct("!thivenone"));
    assertEquals(1, StringPractice.numPunctAfterNonPunct("carrot!"));
    assertEquals(1, StringPractice.numPunctAfterNonPunct("carr!ot"));
    assertEquals(2, StringPractice.numPunctAfterNonPunct("carr!ot!"));
    assertEquals(1, StringPractice.numPunctAfterNonPunct("carr!!ot"));
  }
}
