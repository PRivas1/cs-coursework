...
public class ArrayPracticeTest {
	...
	public void testSwap() {
	  ...
	  int output[] = {1,5,3,4,2,6};

	  ArrayPractice.swap(input, 1, 4);
	...
	public void testIsOdd() {
      assertEquals(true, ArrayPractice.isOdd(5));
	  assertEquals(true, ArrayPractice.isOdd(7));
	  assertEquals(false, ArrayPractice.isOdd(8));
	  assertEquals(false, ArrayPractice.isOdd(10));
	}
